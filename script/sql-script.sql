...
CREATE TABLE `qrtz_job_details` (
  ...
  KEY `IDX_QRTZ_JOB_NAME` (`JOB_NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for qrtz_job_fired_details
-- ----------------------------
DROP TABLE IF EXISTS `qrtz_job_fired_details`;
CREATE TABLE `qrtz_job_fired_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `jobName` varchar(200) DEFAULT NULL,
  `jobGroup` varchar(200) DEFAULT NULL,
  `triggerName` varchar(200) DEFAULT NULL,
  `triggerGroup` varchar(200) DEFAULT NULL,
  `jobType` varchar(50) DEFAULT NULL,
  `jobStatus` varchar(50) DEFAULT NULL,
  `startDate` datetime DEFAULT NULL,
  `endDate` datetime DEFAULT NULL,
  `fireDate` datetime DEFAULT NULL,
  `nextFireDate` datetime DEFAULT NULL,
...
CREATE TABLE `qrtz_triggers` (
  ...
  KEY `IDX_QRTX_T_JOBNAME` (`JOB_NAME`),
